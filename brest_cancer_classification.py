...
l2_model = LogisticRegression(random_state=123, penalty='l2', solver='lbfgs', max_iter=5000)
...
# Define a logistic regression model with above arguments
l1_model = LogisticRegression(random_state=123, penalty='l1', solver='saga', max_iter=5000)
...
param_grid = {
    'n_estimators': [2*n+1 for n in range(5)],  # Reduced the range for smaller grid (1, 3, 5, 7, 9)
    'max_depth': [2*n+1 for n in range(5)],     # Reduced max depth options (1, 3, 5, 7, 9)
    'max_features': ['sqrt', 'log2', None]      # No changes to max_features
}
